                            ...
                            <div key={vid.id} className="flex flex-col gap-3 p-3 bg-card border rounded-md">
                                ...
                                <div className="mt-2 rounded-md overflow-hidden bg-black aspect-video max-w-sm">
                                    <video
                                        ...
                                        preload="metadata"
                                    >
                                        <source src={vid.video_url.startsWith('http') ? vid.video_url : `http://localhost:5000/api/s3/public/${vid.video_url}`} type="video/mp4" />
                        ...
                        <CardContent className="space-y-4 text-sm">
                            {course.thumbnail_url && (
                                <div className="aspect-video w-full rounded-md overflow-hidden bg-muted">
                                    <img src={course.thumbnail_url.startsWith('http') ? course.thumbnail_url : `http://localhost:5000/api/s3/public/${course.thumbnail_url}`} className="w-full h-full object-cover" alt="Thumbnail" />
                                </div>
                            )}
